...
app.controller('ngAmmendClockByDateCtrl', function ($scope, $http) {
    $scope.FetchDDLDataSource = function () {
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlBranch").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlGrade").html('');
            $("#ddlGrade").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlDesignation").html('');
            $("#ddlDesignation").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
            for (var i = 0; i < d.length; i++) {
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlDepartment").html('');
            $("#ddlDepartment").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
            for (var i = 0; i < d.length; i++) {
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlShiftType").html('');
            $("#ddlShiftType").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
            for (var i = 0; i < d.length; i++) {
        ...
        .success(function (data, status) {
            var d = data.d;
            $("#ddlEmpType").html('');
            $("#ddlEmpType").append('<option value="0" data-left="<span style=margin-right:5px; color:#ccc;>0</span>">ALL</option>');
               for (var i = 0; i < d.length; i++) {
