    ...
    <ul class="app-bar-menu small-dropdown" runat="server" id="ul_Menu">
        ...
        <li data-flexorder="2" data-flexorderorigin="1">
            ...
            <ul class="d-menu" data-role="dropdown">
                ...
                <li><a href="BulkClocking.aspx">Bulk Clocking</a></li>
            </ul>
        </li>


    </ul>
    <ul class="app-bar-menu small-dropdown" runat="server" id="ul2">
        <li data-flexorder="3" data-flexorderorigin="2" id="li_1">
            <a href="PaySlip.aspx">PaySlip</a>
        </li>
        <li data-flexorder="2" data-flexorderorigin="1">
            <a class="dropdown-toggle">Leave</a>
            <ul class="d-menu" data-role="dropdown">
                <li><a href="ApplyLeave.aspx">Leave Summary</a></li>
                <li><a href="LeaveRequest.aspx">Leave Request</a></li>
            </ul>
        </li>
