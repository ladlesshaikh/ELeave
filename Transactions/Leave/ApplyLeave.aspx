    ...
    <form runat="server">
        ...
        <div data-role="dialog" title="Leave Application" id="dialog" class="padding20 dialog" style="display: none">
            <div class="Popup_Header">
                ...
                <table style="font-size: 12px; width: 100%; margin-top:30px;">
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td style="color:#ff0000; font-size:13px; padding-bottom:7px;">
                            {{Med_Status}}
                        </td>
                    </tr>
                    <tr>
            ...
            <table style="position: absolute; top: 421px; left: 12px; font-size: 12px;">
                <tr>
                    <td>Total Leave(s)</td>
            ...
            <input type="button" class="JQueryButton" value="Save" id="btnLeaveAppSave" data-ng-click="SaveLeave();attachLeaveDocs();" style="float: right; margin-top: 5px;" />
        </div>
